...
class TestUser(unittest.Testcase):
    ...
    def test_update_at_pubilc_datetime(self):
    ...
    def test_2_users_Uids(self):
        user1 = User()
        user2 = User()
        self.assertNotEqual(user1.id, user2.id)

    def test_2_user_different_created_at(self):
        user1 = User()
        sleep(0.05)
        user2 = User()
        self.assertLess(user1.created_at, user2.updated_at)
